...
<html lang="pt-BR" style="margin:0;padding:0;box-sizing:border-box;">
  ...
  <body style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background:#ffffff; color:#000000; margin:0; padding:40px 10px; display:flex; flex-direction:column; align-items:center; justify-content:flex-start; min-height:100vh;">
    ...
    <div style="display:flex; align-items:center; justify-content:center; gap:20px; margin-bottom:30px;">
      <img src="./logofipe.0ab6fef0.png" alt="Logo FIPe" style="width:20vw; height:auto;">
      <div style="display:flex; flex-direction:column; justify-content:center;">
        <div style="font-size:7vw; font-weight:500; margin-bottom:4px;">Comprovante de Pesca</div>
        <div style="font-size:7vw; font-weight:700;">Categoria Motorizada</div>
      </div>
    </div>

    <!-- QRCode centralizado -->
    <div style="width:40vw; height:40vw; border:2px solid #000000; border-radius:12px; padding:10px; background:#ffffff;">
      <img src="data:image/png;base64,${dataURL}" alt="QRCode" style="width:100%; height:100%; object-fit:contain; border-radius:8px;">
    </div>

    <!-- Código principal -->
    <div style="font-size:7vw; font-weight:bold; margin-top:8px; margin-bottom:10px; text-align:center;">
      ${fishRecord.code}
    </div>

    <!-- Linha divisória -->
    <div style="width:80%; height:2px; background:#000000; margin-bottom:12px;"></div>

    <!-- Código do Time e Nº da Ficha alinhados e com mesmo tamanho -->
    <div style="display:flex; justify-content:center; gap:10px; width:50%; margin-bottom:12px;">
      <div style="flex:1; max-width:50%; border:3px solid #000000; padding:6px; border-radius:6px; text-align:center; font-size:4vw;">
    ...
    <!-- Medida -->
    <div style="display:flex; justify-content:space-between; width:50%; font-size:4vw; margin:4vw 0;">
      <span>Medida:</span>
      <strong>${fishRecord.size}</strong>
    </div>
    ...
    <div style="font-size:7vw; font-weight:bold; padding:12px; border:5px dashed #000000; border-radius:10px; text-align:center; margin:8px 0;">
      Pontuação: ${fishRecord.point}
    </div>

    <!-- Fiscal -->
    <div style="display:flex; justify-content:space-between; width:50%; font-size:3vw; margin:4px 0;">
      <span>Fiscal:</span>
    ...
    <div style="display:flex; justify-content:space-between; width:50%; font-size:3vw; margin:4px 0;">
      <span>Data:</span>
      <strong>${fishRecord.created_at}</strong>
    </div>

    <!-- Coordenada -->
    <div style="display:flex; justify-content:space-between; width:50%; font-size:3vw;">
