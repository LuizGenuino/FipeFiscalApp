...
export function ModalViewScore({ showModal, setShowModal, fishRecord, handleConfirmSubmit, qrRef }: ModalConfirmScoreProps) {
                    ...
                    > */}
                        ...
                        /> */}
                            ...
                            <View style={styles.modalButtons}>
                                ...
                                >
                                    <Text style={styles.modalButtonSecondaryText}>Fehcar</Text>
                                </TouchableOpacity>
                                <TouchableOpacity
...
const styles = StyleSheet.create({
    // container: {},
    // scrollContent: { flex: 1, width: "100%" },
    modalOverlay: {
        flex: 1,
